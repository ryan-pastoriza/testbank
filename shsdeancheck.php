...
$sql = "SELECT major_exams.exam_id, shs_tqstatus.shs_ph, shs_subject.shs_subj_name, employees.employee_fname, employees.employee_mname, employees.employee_lname, employees.employee_ext, shs_tq.shs_upload_tq, shs_tq.shs_upload_tos, user_access.user_id FROM shs_tq INNER JOIN major_exams ON shs_tq.exam_id = major_exams.exam_id INNER JOIN shs_tqstatus ON shs_tqstatus.shs_tq_id = shs_tq.shs_tq_id INNER JOIN shs_syll ON shs_tq.shs_syll_id = shs_syll.shs_syll_id INNER JOIN shs_subject ON shs_syll.shs_subj_id = shs_subject.shs_subj_id INNER JOIN employment ON shs_syll.employment_id = employment.employment_id INNER JOIN employees ON employment.employee_id = employees.employee_id INNER JOIN user_access ON user_access.employment_id = employment.employment_id WHERE shs_tq.shs_tq_id ='". $tq_id."' ";
  $result = mysql_query($sql);
    if(!$result){
      ...
      while($row=mysql_fetch_array($result)){
        ...
        $shs_upload_tq=$row['shs_upload_tq'];
        $shs_upload_tos=$row['shs_upload_tos'];
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row" >
        ...
        <?php
            if (strlen($shs_upload_tq)>0 AND strlen($shs_upload_tos)>0) {
              ?>
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="col-xs-10"> 
                          ...
                          if (isset($_POST['revise'])) {
                            //$class->remarks();
                            $class->deanuploadstatus($tq_id,"revise",$position_session,"shs");
                        ...
                        <div class="col-xs-2"> 
                          ...
                          if (isset($_POST['approve'])) {
                            //$class->remarks();
                            $class->deanuploadstatus($tq_id,"approve",$position_session,"shs");
                           } ?>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
               ...
               <div class="col-md-4">
                ...
                <div class="col-xs-2"> 
                  ...
                  if (isset($_POST['revise'])) {
                    $class->shsremarks();
                    $class->shscheckqstat($ph,$tq_id,$position_session,"revise");
                    if ($position_session=="Academic Head") {
                              $class->notifdean($dep,$user_id,$instructor);
                            }
                   } ?>
                ...
                <div class="col-xs-2"> 
                  ...
                  if (isset($_POST['approve'])) {
                    $class->shsremarks();
                    $class->shscheckqstat($ph,$tq_id,$position_session,"approve");
                   } ?>
                </div>
              </div>
            </div>
