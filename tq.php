                  ...
                  <div class="box box default">
                    <div class="tab-content " id="testtable">
                      ...
                      <form method="post">
                        ...
                        <br>
                        <table class="table table-bordered"43 id="identification_field">
                          <tr>
                            <td>
                              <div class="row">
                                <div class="col-xs-2">
                                  ...
                                  ?><option value="<?php echo $roll2[$j];?>">
                                  <?php echo $roll2[$j];?></option><?php
                                  }?>
                                  </select>
                                </div>
                                  <div class="col-xs-10">
                          ...
                          <div class="col-xs-12">
                            <button type="button" class="pull-right btn btn-default" name="idensave">
                          <i class="glyphicon glyphicon-floppy-save"></i> Save </button>
                          <?php if (isset($_POST['idensave'])) ?>
                          </div>
                      </form>
