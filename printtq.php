  ...
  $result = mysql_query($sql);
    if(!$result){
      ...
      while($row=mysql_fetch_array($result)){
        ...
        $upload_tq=utf8_encode($row['upload_tq']);
        $upload_tos=utf8_encode($row['upload_tos']);
                          ...
                          <div class="col-md-12">
                            ...
                            <?php 
                             ...
                             <input type="hidden" name="message" class="form-control" value="<?php echo "$msg"; ?>">
                              <button type="submit" class="pull-right btn btn-primary" id="print" name="print" onclick="printDiv('printableAreaa', '<?php echo $tq_id; ?>', '<?php echo $contact; ?>', '<?php echo $msg; ?>')">
