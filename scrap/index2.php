            ...
            <div class="box-body table-responsive no-padding" style="overflow-y:scroll; overflow-x:hidden; height:500px;">
              <table class="table table-hover">
                <tr>
                  ...
                  <td class="col-lg-1"><a href="tq.php"><i class="glyphicon glyphicon-pencil createtq"><span class="createtqtext">Create TQ</span></i></a></td>
                  <td class="col-lg-1"><a href="tq.php"><i class="glyphicon glyphicon-edit edittq"><span class="edittqtext">Edit TQ</span></i></a></td>
                </tr>
                <tr>
