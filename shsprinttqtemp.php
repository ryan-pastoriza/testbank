    ...
    <table width="800">
      ...
      <tr>
        <td colspan="4" align="center"><h5><b><?php $class->shscheckperiod($tq_id); ?> Examinition</b></h5></td>
      </tr>
      <tr>
      	<td colspan="4" align="center"><h5><b><?php $class->shschecksub($tq_id); ?></b></h5></td>
      </tr>
      <tr>
        <td><br></td>
      </tr>
      <?php $class->shsloadinstruction($tq_id); ?>
    </table>
    
      <?php $class->shspreviewtq($tq_id); ?>
    <br>
