                              ...
                              <td>
                                <div class="row">
                                  <div class="col-xs-2">
                                    <?php 
                                    $class->loaddb();
                                    $query = "SELECT testquestions.number FROM testquestions INNER JOIN test_number ON testquestions.test_id = test_number.test_id INNER JOIN question_type ON test_number.question_type_id = question_type.question_type_id WHERE question_type.question_type_name = 'identification'";
                                  ...
                                  <div class="col-xs-10">
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-btn">
                                        <button class="btn btn-default idennumimport'+iden_num+'" id="idennumimport'+iden_num+'" name="idenimport'+iden_num+'" type="button">
                                          <i class="fa fa-paperclip"></i>
                                        </button>
                                      </span>
                                    </div>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  idenaddnum"><span class="idenaddnumtext">Add number</span></i></a>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  enuaddnum"><span class="enuaddnumtext">Add number</span></i></a>
                              </td>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  multiaddnum"><span class="multiaddnumtext">Add number</span></i></a>
                              </td>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  tofaddnum"><span class="tofaddnumtext">Add number</span></i></a>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  matchaddnum"><span class="matchaddnumtext">Add number</span></i></a>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="box-body">
                          <table class="col-xs-12">
                            <tr>
                              ...
                              <td class="col-xs-1">
                                <a href="#"><i class="fa fa-save  probaddnum"><span class="probaddnumtext">Add number</span></i></a>
                              </td>
                            </tr>
                          </table>
                        </div>
...
function createtq($emp_id,$subj_id){
    $this->loaddb();
    $sql = "SELECT `sched_subj`.ss_id,`subject`.subj_id, `subject`.subj_code, `subject`.subj_name, `subject`.subj_desc, unit_lecture.unit FROM sched_subj INNER JOIN employment ON sched_subj.employment_id = employment.employment_id INNER JOIN `subject` ON sched_subj.subj_id = `subject`.subj_id INNER JOIN unit_lecture ON unit_lecture.subj_id = `subject`.subj_id WHERE sched_subj.employment_id = $emp_id AND subject.subj_id= $subj_id";
      $result = mysql_query($sql);
          while($row=mysql_fetch_array($result)){
            ...
            if(mysql_num_rows($result2)==0){
                $query = "INSERT INTO `subject_info` (`subject_name`, `subject_code`,`subject_unit`,`subject_description`) VALUES ('".$subj_name1."','".$subj_code1."','".$unit1."','".$subj_desc1."')";
