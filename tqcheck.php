              ...
              <div class="row">
                ...
                <div class="col-xs-2"> 
                  ...
                  if (isset($_POST['revise'])) {
                    $class->remarks();
                    $class->checkqstat($ph,$tq_id,"ph","revise");
                ...
                <div class="col-xs-2"> 
                  ...
                  $class->remarks();
                   $class->checkqstat($ph,$tq_id,"ph","approve");
