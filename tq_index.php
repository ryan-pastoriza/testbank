        ...
        <section class="col-lg-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>College TQ</b></h3>
            </div>
            <div class="box-body">
              <table class="table table-hover table-striped table-bordered" id="tqsub">
                <thead>
                  <tr>
                    <th>Subject</th>
...
function calc(){
  ...
  if (sdep=='GEN') {
    ...
    if ((lots>=35 && lots<=45) && (hots>=55 && hots<=65)) {
      ...
      $.each(obj, function(key , value) {
        ...
        $.each(value.msg , function(k , v ){ 
          if (!(v=='No subject found' || v=='Error Database')) {
            $("#tbsub").append('<tr class="subdata"><td>'+ v+'</td><td><button type="button" onclick="delsub('+syllid+')" class="btn btn-danger btn-xs glyphicon glyphicon-trash" ></button></td></tr>');
          }else{
