...
if ( !empty ( $_GET ) ) {
  ...
  $sql=mysql_query("SELECT `subject`.subj_id, `subject`.subj_name, sched_subj.department, major_exams.exam_period, school_year.sy, semester.semester FROM tq INNER JOIN syllabus ON tq.syllabus_id = syllabus.syllabus_id INNER JOIN sched_subj ON syllabus.ss_id = sched_subj.ss_id INNER JOIN `subject` ON sched_subj.subj_id = `subject`.subj_id INNER JOIN major_exams ON tq.exam_id = major_exams.exam_id INNER JOIN school_year ON sched_subj.sy_id = school_year.sy_id INNER JOIN semester ON sched_subj.sem_id = semester.sem_id WHERE tq.tq_id =  $tq_id");
  while ($row=mysql_fetch_array($sql)) {
    $subj_id=$row['subj_id'];
    $subject=$row['subj_name']."(".$row['exam_period'].")";
    $subject1=$row['subj_name'];
            ...
            <div class="box  box-primary" id="div1">
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-xs-12">
                    <div class="input-group">
                      <span class="input-group-addon" id="basic-addon1">General Direction/s</span>
                      <textarea rows="2" placeholder="Enter General Directions" style="width: 100%; resize: vertical; " name="maindirection" id="maindirection" required></textarea>   
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="input-group">
                      <span class="input-group-addon" id="basic-addon1">Specific Direction</span>
                      <textarea placeholder="Enter Specific Direction" style="width: 100%; height: 33px; resize: vertical; " id="direction" name="direction" required></textarea>
                      <span class="input-group-btn">
                      <span class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" >
                            <i class="fa fa-asterisk"></i>
                          </span>
                        ...
                        <span class="btn btn-file" id="attdirect">
                          <i class="fa fa-paperclip"></i>
                          <input type="file" name="directionfile">
                        </span>
                        <span class="btn" id="delattdirect" style="display:none">
                          <i class="glyphicon glyphicon-erase" onclick="delattdirect()" ></i>
                        </span>
                      </span>  
                    </div>
                  </div>
                  ...
                  <div class="col-xs-12">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        ...
                        <span class="btn" id="delattquest" style="display:none">
                          <i class="glyphicon glyphicon-erase" onclick="delattquest()" ></i>
                        </span>
                      </span>
              ...
              <div class="box-footer clearfix">
                <div class="row">
                  ...
                  <?php 
                  if ($position_session=="Dean" AND ($depart == $department )) {
                    ?>
            ...
            <div class="box  box-primary" id="div2">
              ...
              <div class="box-body">
                          ...
                          if (isset($name1)) {
                            if (!empty($name1)) {
                              ...
                              if (move_uploaded_file($tmp_name1, $location.$tosup)) {
                                $class->insertup($tosup,"tos",$tq_id);
                              }else{
                                echo "There was an error.";
                              }
                            }else{
                ...
                <table class="table table-hover table-striped table-bordered" id="qstored">
                  ...
                  <tbody>
                    <?php
                    $class->loaduploadedtq($subject1,$tq_id);
                    ?>
                  </tbody>
                </table>
              </div>
...
//         e.preventDefault();  
//         window.location.href = 'upload_tq/'+dl;
...
//         e.preventDefault();  
//         window.location.href = 'upload_tos/'+dl;     
//     }
//     });
// }
function fun(tqid){
...
function submitph(val,pos){
  ...
  $.ajax({
    type:"POST",
    url:"tqcrud.php?p=submitph",
    data:{tq_id: tq_id, ph_id: ph_id, position: position, period: period},
    success: function(data){
      var msg;
      var obj = $.parseJSON(data);
      $.each(obj, function(key , value) {
